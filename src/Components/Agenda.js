...
function Agenda() {
    return (
        <Box sx={{ paddingBottom: '20px' }}>
            ...
            <Box sx={{ textAlign: 'center', fontSize: '38px', fontWeight: "900" }}><RainbowText>Agenda</RainbowText></Box>
            <Stack direction="column" spacing={2} alignItems="center" sx={{ fontSize: { xs: "20px", md: "1.2em" } }}>
