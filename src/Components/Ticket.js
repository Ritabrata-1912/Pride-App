...
export default function Ticket(props){
    return(
        <Box sx={{backgroundImage:`url(${img})`,backgroundSize:"contain",backgroundRepeat:"no-repeat",fontFamily: `'Kanit', sans-serif`,backgroundColor:"#f6f6e9",width:{xs:'250',md:'250'},height:{xs:"350",md:"350"}}}>
