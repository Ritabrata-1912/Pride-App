...
function About() {
  return (
    <Box sx={{ paddingBottom: '20px', marginTop: "20px" }}>
      <Stack alignItems="center" sx={{ marginTop: "20px" }}><Button sx={{ width: { xs: "150px", md: "300px" }, height: "50px", borderRadius: "50px", padding: "10px", boxShadow: "0 0 3px black",backgroundColor:"#088f8f",color:"white" }}><Accessibility sx={{ marginRight: "10px" }} /> <Link to="reg" spy={true} smooth={true} offset={50} duration={500}>Join Us</Link></Button></Stack>
